...
public class Assignment1_Sorting_Dropdownlist {
...
//			}
		...
		List <WebElement> myskills = selectSkill.getOptions();
		...
		System.out.println("sorted in ascending order or not "+actualList.equals(Temp));
